...
const styles = StyleSheet.create({
  ...
  powerZone: { alignItems: 'center', marginTop: 8 },
  powerWrap: { width: 116, height: 116, borderRadius: 58 },
  powerRing: { flex: 1, borderRadius: 58, padding: 4 },
  powerInner: { flex: 1, backgroundColor: '#0f0b26', borderRadius: 54, justifyContent: 'center', alignItems: 'center' },
  powerIcon: { fontSize: 32, color: '#fff' },
  powerLabel: { fontSize: 13, fontWeight: '800', marginTop: 2 },
  serverName: { color: NeonTheme.colors.textSecondary, fontSize: 12, marginTop: 6, paddingHorizontal: 30 },

  tiles: { flexDirection: 'row', gap: 8, paddingHorizontal: 18, marginTop: 8, paddingBottom: 12 },
  tile: { flex: 1, backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 14, paddingVertical: 7, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  ...
  actions: { flexDirection: 'row', gap: 8, paddingHorizontal: 16, marginTop: 8 },
  action: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, backgroundColor: NeonTheme.colors.bgCard, borderRadius: 14, paddingVertical: 10, borderWidth: 1, borderColor: NeonTheme.colors.border },
  ...
  search: {
    backgroundColor: NeonTheme.colors.bgCard, borderRadius: 14, paddingHorizontal: 16,
  ...
  sectionRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, marginTop: 10, marginBottom: 2 },
